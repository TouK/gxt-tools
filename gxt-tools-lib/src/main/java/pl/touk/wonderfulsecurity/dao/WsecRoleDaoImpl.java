...
// --------------------- Interface WsecRoleDao ---------------------

    public WsecRole getRoleByName(String roleName) {
        List<WsecRole> result = getHibernateTemplate().findByCriteria(DetachedCriteria.forClass(WsecRole.class).add(Restrictions.eq("name", roleName)));
