...
public class SimpleDictionary extends TabItem {
    ...
    public SimpleDictionary(String text) {
        super(text);
        this.setLayout(new RowLayout());

        this.add(new Text("To jest przetłumaczona wratość klucza: PREPAID " + ClientDictionary.transtalteKeyToStringValue("PREPAID")));
    }
}
